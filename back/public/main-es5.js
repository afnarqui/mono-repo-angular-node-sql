...
var ClienteComponent = /** @class */ (function () {
    function ClienteComponent(service) {
    ...
    ClienteComponent.prototype.get = function () {
    ...
    ClienteComponent.prototype.guardar = function (datos) {
        var _this = this;
        var data = this.service.guardar(datos)
            .subscribe(function (items) {
            _this.get();
        });
    };
    ClienteComponent.prototype.saveFile = function () {
    };
    ClienteComponent.prototype.actualizar = function () {
    };
    ClienteComponent.prototype.buscar = function () {
        this.get();
    };
...
var ClienteService = /** @class */ (function () {
    ...
    ClienteService.prototype.get = function () {
        console.log(this.url);
        return this.http.get(this.url + "clientes");
    };
    ClienteService.prototype.guardar = function (clientes) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.post(this.url + 'clientes/', JSON.stringify(clientes), { headers: headers });
    };
    ClienteService.prototype.actualizar = function (clientes) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.put(this.url + "/clientes/", clientes, { headers: headers });
    };
